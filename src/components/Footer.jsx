...
const Footer = () => {
  return (
    <footer className="bg-gray-900/80 backdrop-blur-sm text-white mt-auto border-t border-gray-800/50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="text-center sm:text-left">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/hire" className="text-gray-300 hover:text-blue-400 transition-colors">
                  Hire Me
                </Link>
              </li>
            </ul>
          ...
          {/* Social Links */}
          <div className="text-center sm:text-left">
            <h3 className="text-xl font-semibold text-blue-400 mb-4">Connect</h3>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800/50 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Samuel Htamu. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
